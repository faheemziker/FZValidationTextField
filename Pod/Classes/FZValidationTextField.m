...
-(void) awakeFromNib {
    ...
    iconImageView=[[UIImageView alloc] initWithImage:[self imageWithName:IMAGE_ERROR_ICON]];
...
-(UIImage *)imageWithName:(NSString *)imageName {
    ...
    NSBundle* bundle = [NSBundle bundleWithURL:[[NSBundle mainBundle]URLForResource:@"FZValidationTextField" withExtension:@"bundle"]];
...
-(void) validationPass {
    ...
    UIImage *redIcon=[self imageWithName:IMAGE_PASS_ICON];
    [iconImageView setImage:redIcon];
    [iconImageView setHidden:NO];
}

-(void) validationFailed {
    UIImage *redIcon=[self imageWithName:IMAGE_ERROR_ICON];
    [iconImageView setImage:redIcon];
    [iconImageView setHidden:NO];
}
