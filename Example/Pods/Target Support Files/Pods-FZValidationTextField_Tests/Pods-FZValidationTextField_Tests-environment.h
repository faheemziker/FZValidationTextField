...
#define COCOAPODS_POD_AVAILABLE_FZValidationTextField
#define COCOAPODS_VERSION_MAJOR_FZValidationTextField 0
#define COCOAPODS_VERSION_MINOR_FZValidationTextField 1
#define COCOAPODS_VERSION_PATCH_FZValidationTextField 0
